...
interface IPureFiFarming2Verifiable{
    function depositTo(uint16 _pid, uint256 _amount, address _beneficiary, uint256 _ruleId, bytes calldata _purefidata) external payable;
    function deposit(uint16 _pid, uint256 _amount, uint256 _ruleId, bytes calldata _purefidata) external payable;
